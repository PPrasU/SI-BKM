...
<head>
    <title>SI-BKM | Edit Data Penguatan UMKM</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Edit Data Penguatan UMKM Masyarakat Tanjungrejo</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Admin/Penguatan-UMKM">
                                        Penguatan UMKM</a></li>
                                <li class="breadcrumb-item"><a href="/Admin/Penguatan-UMKM/Edit-Data">Edit
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <form action="/Admin/Penguatan-UMKM/Update-Data/{{ $data->id }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="detail_penguatan_UMKM" class="form-control"
                                                    ...
                                                    value="{{ $data->detail_penguatan_umkm }}"
                                    ...
                                    <div class="card-footer">
                                        <a href="/Admin/Penguatan-UMKMM" class="btn btn-default">Batal</a>
