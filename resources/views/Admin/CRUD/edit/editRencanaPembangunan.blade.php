...
<head>
    <title>SI-BKM | Edit Data Rencana Pembangunan</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Edit Data Rencana Pembangunan</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Rencana-Pembangunan">Rencana
                                        Pembangunan</a>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Rencana-Pembangunan/Update-Data/{{ $data->id }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Rencana Pembangunan Dengan</label>
                                            <select class="form-control" name="rencana_pembangunan_dengan"
                                                id="rencana_pembangunan_dengan" value="{{ $data->rencana_pembangunan_dengan }}">
                                                <option selected>{{ $data->rencana_pembangunan_dengan }}</option>
                                                <option disabled>-- Bekerja Sama Dengan --</option>
                                                <option>Pemkot</option>
                                                <option>Pokir</option>
                                                <option>Dinas Terkait</option>
                                                <option>Lembaga Negeri</option>
                                                <option>Lembaga Swasta</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <a href="/Admin/Rencana-Pembangunan" type="submit"
