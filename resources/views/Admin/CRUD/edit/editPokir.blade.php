...
<head>
    <title>SI-BKM | Edit Data Rencana Pembangunan Dengan Pokir</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Edit Data Rencana Pembangunan Dengan Pokir</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Pokir">Pokir</a></li>
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Pokir/Edit-Data">Edit
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Pokir/Update-Data/{{ $data->id }}" method="POST"
