...
<head>
    <title>SI-BKM | Edit Data Rencana Pembangunan Dengan Dinas Terkait</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Edit Data Rencana Pembangunan Dengan Dinas Terkait</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Dinas-Terkait/Edit-Data">Edit
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Dinas-Terkait/Update-Data/{{ $data->id }}" method="POST"
