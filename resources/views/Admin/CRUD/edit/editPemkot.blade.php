...
<head>
    <title>SI-BKM | Edit Data Rencana Pembangunan Dengan Pemkot</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Edit Data Rencana Pembangunan Dengan Pemkot</h5>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Pemkot/Update-Data/{{ $data->id }}" method="POST"
