        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Data Penguatan SDM Masyarakat Tanjungrejo</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Admin/Penguatan-SDM">
                                        Penguatan SDM</a></li>
                                <li class="breadcrumb-item"><a href="/Admin/Penguatan-SDM/Input-Data">Input
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <form action="/Admin/Penguatan-SDM/Post-Data" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="detail_penguatan_sdm">Detail Penguatan UMKM</label>
                                            <div class="input-group mb-3">
                                                <input type="text" name="detail_penguatan_sdm" class="form-control"
                                                    id="detail_penguatan_sdm"
