...
<head>
    <title>SI-BKM | Input Data Rencana Pembangunan Dengan Lembaga Swasta</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Data Rencana Pembangunan Dengan Lembaga Swasta</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Lembaga-Swasta/Input-Data">Input
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Pembangunan/Lembaga-Swasta/Post-Data" method="POST"
