...
<head>
    <title>SI-BKM | Input Data Rencana Pembangunan</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Data Rencana Pembangunan</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Rencana-Pembangunan">Rencana Pembangunan</a>
                                </li>
                                <li class="breadcrumb-item"><a href="/Admin/Rencana-PembangunanInput-Data">Input
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Rencana-Pembangunan/Post-Data" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="rencana_pembangunan_dengan" id="rencana_pembangunan_dengan">
                                                <option selected disabled>Bekerja Sama Dengan</option>
