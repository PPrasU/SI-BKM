...
<head>
    <title>SI-BKM | Input Data Rencana Pembangunan Dengan Dinas Terkait</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Data Rencana Pembangunan Dengan Dinas Terkait</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Dinas-Terkait">Dinas Terkait</a>
                                </li>
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Dinas-TerkaitInput-Data">Input
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Pembangunan/Dinas-Terkait/Post-Data" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Dinas Terkait</label>
                                            <select class="form-control" name="dinas_terkait" id="dinas_terkait">
                                    ...
                                    <div class="card-footer">
                                        <a href="/Admin/Pembangunan/Dinas-Terkait" type="submit"
