...
<head>
    <title>SI-BKM | Input Data Rencana Pembangunan Dengan Lembaga Negeri</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Data Rencana Pembangunan Dengan Lembaga Negeri</h5>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Pembangunan/Lembaga-Negeri/Post-Data" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Lembaga Negeri</label>
                                            <select class="form-control" name="lemb_negeri" id="lemb_negeri">
                                                <option selected>Lembaga Negeri</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <a href="/Admin/Pembangunan/Lembaga-Negeri" type="submit"
