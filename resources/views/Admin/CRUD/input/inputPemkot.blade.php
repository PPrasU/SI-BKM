...
<head>
    <title>SI-BKM | Input Data Rencana Pembangunan Dengan Pemkot</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Data Rencana Pembangunan Dengan Pemkot</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/Pemkot">Pemkot</a></li>
                                <li class="breadcrumb-item"><a href="/Admin/Pembangunan/PemkotInput-Data">Input
                                        Data</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-success">
                                ...
                                <form action="/Admin/Pembangunan/Pemkot/Post-Data" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Pemkot</label>
                                            <select class="form-control" name="pemkot" id="pemkot">
                                                <option selected>Pemkot</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <a href="/Admin/Pembangunan/Pemkot" type="submit"
