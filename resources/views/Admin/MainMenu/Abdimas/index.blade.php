...
<head>
    <title>SI-BKM | Data Abdimas Pemberdayaan Fisik dan Non Fisik</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Abdimas Pemberdayaan Fisik dan Non Fisik</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Abdimas-Fisik-NonFisik">Abdimas Fisik dan
                                        Non
                                        Fisik</a>
                                </li>
                            </ol>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data Abdimas Pemberdayaan Fisik dan Non Fisik Masyarakat</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    @php
                                    ...
                                    @if ($user === 'Admin' || $user === 'Ketua BKM')
                                        <a href="/Admin/Abdimas-Fisik-NonFisik/Input-Data" class="btn btn-app"
                                    ...
                                    <table id="table4" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center align-middle">Kategori Pemberdayaan</th>
                                                <th class="text-center align-middle">Detail Kegiatan</th>
                                                <th class="text-center align-middle">Tanggal Kegiatan Dilakukan</th>
