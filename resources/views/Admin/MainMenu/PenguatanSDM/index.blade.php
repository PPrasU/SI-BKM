...
<head>
    <title>SI-BKM | Data Penguatan SDM</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Penguatan SDM</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Penguatan-SDM">Penguatan SDM</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data Penguatan SDM Tanjungrejo</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    @php
    ...
    <script>
        $('.delete').click(function() {
            ...
            var detail_penguatan_sdm = $(this).attr('data-detail_penguatan_sdm');
            Swal.fire({
                title: 'Apakah Kamu Ingin Menghapus Data Ini?',
                text: "Data Penguatan SDM " + rw + " - " + detail_penguatan_sdm + " Akan Dihapus",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        ...
                        'Data Telah Terhapus!',
                        'success',
                        window.location = "/Admin/Penguatan-SDM/Hapus-Data/" + id + "",
                    )
                }
            });
        });
