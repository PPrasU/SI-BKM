...
<head>
    <title>SI-BKM | Data Lembaga Swasta</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Rencana Pembangunan Dengan Lembaga Swasta</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Lembaga-Swasta">Lembaga Swasta</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data Rencana Pembangunan Dengan Lembaga Swasta</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <a href="/Admin/Pembangunan/Lembaga-Swasta/Input-Data" class="btn btn-app"
                                        style="left: -10px; top: -10px">
                                        <i class="fas fa-plus"></i> Tambah Data
                                    </a>
                                    @if (count($data) > 0)
                                        <a href="/Admin/Lembaga-Swasta/Export-Data/{{ $data[0]->id }}"
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <a href="/Admin/Pembangunan/Lembaga-Swasta/Edit-Data/{{ $row->id }}"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        ...
                        'Data Telah Terhapus!',
                        'success',
                        window.location = "/Admin/Lembaga-Swasta/Hapus-Data/" + id + "",
                    )
                }
            });
        });
