...
<head>
    <title>SI-BKM | Data Dinas Terkait</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Rencana Pembangunan Dengan Dinas Terkait</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Program</li>
                                <li class="breadcrumb-item"><a href="/Admin/Dinas-Terkait">Dinas Terkait</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    @if (count($data) > 0)
                                        <a href="/Admin/Dinas-Terkait/Export-Data/{{ $data[0]->id }}"
    ...
    <script>
        $('.delete').click(function() {
            ...
            Swal.fire({
                ...
                text: "Data perencanaan pembangunan " + rw_rencana_pemb + " - dengan " + detail_pemb +
                    " Akan Dihapus",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        ...
                        'Data Telah Terhapus!',
                        'success',
                        window.location = "/Admin/Dinas-Terkait/Hapus-Data/" + id + "",
                    )
                }
            });
        });
