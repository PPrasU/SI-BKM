...
<head>
    <title>SI-BKM | Data Aspirasi (Rembuk Warga)</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Aspirasi (Rembuk Warga)</h5>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data Aspirasi (Rembuk Warga)</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    @php
    ...
    <script>
        $('.delete').click(function() {
            ...
            Swal.fire({
                ...
                text: "Data abdimas LPPM dari " + asal_rw + " - dengan " + kategori + " Akan Dihapus",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        ...
                        'Data Telah Terhapus!',
                        'success',
                        window.location = "/Admin/Aspirasi-Rembuk-Warga/Hapus-Data/" + id + "",
                    )
                }
            });
        });
